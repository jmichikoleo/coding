...
nutritional_info = {
    ...
    'Mie Ayam': {'total_carbs': 50, 'fiber': 2, 'protein': 10, 'fat': 7, 'glycemic_index': 60},
    'Mie Babi': {'total_carbs': 55, 'fiber': 2, 'protein': 12, 'fat': 8, 'glycemic_index': 65},
    'Nasi Uduk': {'total_carbs': 45, 'fiber': 2, 'protein': 4, 'fat': 5, 'glycemic_index': 70},
    'Nasi Padang': {'total_carbs': 50, 'fiber': 3, 'protein': 6, 'fat': 10, 'glycemic_index': 75},
    'Cereal': {'total_carbs': 60, 'fiber': 5, 'protein': 5, 'fat': 2, 'glycemic_index': 80},
    'Oatmeal': {'total_carbs': 55, 'fiber': 8, 'protein': 6, 'fat': 3, 'glycemic_index': 55},
    'Ayam Goreng': {'total_carbs': 10, 'fiber': 0, 'protein': 15, 'fat': 8, 'glycemic_index': 45},
    'Babi Panggang': {'total_carbs': 5, 'fiber': 0, 'protein': 20, 'fat': 15, 'glycemic_index': 50},
    'Cumi Goreng Tepung': {'total_carbs': 30, 'fiber': 1, 'protein': 10, 'fat': 10, 'glycemic_index': 65},
    'Ayam Geprek': {'total_carbs': 15, 'fiber': 1, 'protein': 18, 'fat': 12, 'glycemic_index': 50},
    'Sate Kambing': {'total_carbs': 5, 'fiber': 0, 'protein': 25, 'fat': 20, 'glycemic_index': 50},
    'Sate Padang': {'total_carbs': 25, 'fiber': 1, 'protein': 15, 'fat': 10, 'glycemic_index': 60},
    'Sop Kambing': {'total_carbs': 20, 'fiber': 2, 'protein': 20, 'fat': 15, 'glycemic_index': 55},
    'Bakso': {'total_carbs': 25, 'fiber': 1, 'protein': 12, 'fat': 8, 'glycemic_index': 60}
}

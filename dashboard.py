...
df = pd.read_csv("AKULAKU_FEB.csv")

# Sort the DataFrame by the "Qty Sold" column in descending order
df_sorted = df.sort_values(by="Qty Sold", ascending=False)

# Select the top 10 rows from the sorted DataFrame
top_10 = df_sorted.head(10)

# Display the top 10 rows DataFrame
st.write(top_10)

# Create a bar chart from the top 10 rows DataFrame
